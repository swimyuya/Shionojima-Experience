...
// Mock confirmation data for experience 2
const confirmationData = {
  bookingId: "SHN-2025-0002",
  experience: {
    id: "2",
    title: {
  ...
  meetingPoint: { ja: "篠島神社 社務所", en: "Shinojima Shrine Office" },
  contactInfo: {
    phone: "0569-67-3333",
    email: "info@shinojima-shrine.jp",
  },
}
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <ul className="text-sm space-y-1 text-muted-foreground">
                    ...
                    <li>
                      •{" "}
                      {language === "ja"
                        ? "神聖な場所での体験のため、適切な服装でお越しください"
                        : "Please dress appropriately for this sacred experience"}
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="text-sm space-y-1 text-muted-foreground">
                    <li>
                      •{" "}
                      {language === "ja" ? "清潔な服装（白い服装推奨）" : "Clean clothing (white clothing recommended)"}
                    </li>
                ...
                <div>
                  <h4 className="font-semibold mb-2">{language === "ja" ? "注意事項" : "Important Notes"}</h4>
                  <p className="text-sm text-muted-foreground">
                    {language === "ja"
                      ? "この体験は神聖な儀式の一部です。写真撮影は指定された場所のみで可能です。"
                      : "This experience is part of a sacred ritual. Photography is only allowed in designated areas."}
                  </p>
                </div>
