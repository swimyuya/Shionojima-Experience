...
export default function Experience4BookingPage() {
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="flex items-start space-x-2">
                    ...
                    <Label htmlFor="terms" className="text-sm leading-relaxed">
                      {language === "ja"
                        ? "利用規約およびキャンセルポリシーに同意します。早朝4:30集合のため、前日宿泊を強く推奨いたします。天候により内容が変更される場合があることを理解しています。"
                        : "I agree to the terms and conditions and cancellation policy. I understand that overnight accommodation is strongly recommended due to the 4:30 AM start time, and that the experience may be modified due to weather conditions."}
                    </Label>
                  </div>
                ...
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
                  <div className="flex items-start">
                    ...
                    <div className="text-sm text-yellow-800">
                      <p className="font-semibold mb-1">{language === "ja" ? "重要なお知らせ" : "Important Notice"}</p>
                      <p>
                        {language === "ja"
                          ? "早朝4:30集合のため、前日宿泊を強く推奨いたします。"
                          : "Overnight accommodation strongly recommended due to 4:30 AM start time."}
                      </p>
                    </div>
                  </div>
                </div>
