...
// Mock confirmation data for experience 4
const confirmationData = {
  bookingId: "SHN-2025-0004",
  experience: {
    id: "4",
    title: {
      ja: "早朝漁業体験 - 朝市と魚の競り",
  ...
  meetingPoint: { ja: "篠島漁港 競り場", en: "Shinojima Fishing Port Auction Hall" },
  contactInfo: {
    phone: "0569-67-2111",
          ...
          <div className="max-w-4xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <ul className="text-sm space-y-1 text-muted-foreground">
                    ...
                    <li>
                      •{" "}
                      {language === "ja"
                        ? "早朝のため、十分な睡眠をとってお越しください"
                        : "Please get enough sleep as this is an early morning experience"}
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="text-sm space-y-1 text-muted-foreground">
                    <li>
                      ...
                      {language === "ja"
                        ? "暖かい服装（早朝は冷え込みます）"
                        : "Warm clothing (early morning can be cold)"}
                    </li>
                    <li>• {language === "ja" ? "滑りにくい靴" : "Non-slip shoes"}</li>
                    <li>• {language === "ja" ? "カメラ（撮影可能）" : "Camera (photography allowed)"}</li>
                    <li>
                      • {language === "ja" ? "現金（魚の購入希望者）" : "Cash (for those wishing to purchase fish)"}
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  <h4 className="font-semibold mb-2">{language === "ja" ? "魚の購入について" : "Fish Purchase"}</h4>
                  <p className="text-sm text-muted-foreground">
                    {language === "ja"
                      ? "競りで落札された新鮮な魚を特別価格で購入できます。クーラーボックスの貸出も可能です。"
                      : "You can purchase fresh fish from the auction at special prices. Cooler box rental is available."}
                  </p>
                </div>
