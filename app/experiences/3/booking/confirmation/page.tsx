...
// Mock confirmation data for experience 3
const confirmationData = {
  bookingId: "SHN-2025-0003",
  experience: {
    id: "3",
    title: {
      ja: "島の恵み料理教室 - 海の幸を味わう",
    ...
    price: 6800,
    duration: { ja: "2.5時間", en: "2.5 hours" },
    category: { ja: "グルメ・食育", en: "Gourmet & Food Education" },
    location: { ja: "篠島料理教室", en: "Shinojima Cooking Studio" },
    host: { ja: "篠島料理研究会", en: "Shinojima Culinary Association" },
  },
  ...
  meetingPoint: { ja: "篠島コミュニティセンター", en: "Shinojima Community Center" },
  contactInfo: {
    phone: "0569-67-4444",
    email: "info@shinojima-cooking.jp",
  },
}
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <ul className="text-sm space-y-1 text-muted-foreground">
                    ...
                    <li>• {language === "ja" ? "料理教室は2階です" : "Cooking studio is on the 2nd floor"}</li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="text-sm space-y-1 text-muted-foreground">
                    <li>• {language === "ja" ? "エプロン（貸出可能）" : "Apron (rental available)"}</li>
                    <li>• {language === "ja" ? "タオル" : "Towel"}</li>
                    <li>• {language === "ja" ? "髪の長い方はヘアゴム" : "Hair tie for long hair"}</li>
                    <li>
                      • {language === "ja" ? "持ち帰り用の容器（希望者のみ）" : "Container for takeaway (optional)"}
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  <h4 className="font-semibold mb-2">{language === "ja" ? "アレルギーについて" : "Allergies"}</h4>
                  <p className="text-sm text-muted-foreground">
                    {language === "ja"
                      ? "食物アレルギーをお持ちの方は、事前にご連絡ください。可能な限り対応いたします。"
                      : "Please contact us in advance if you have any food allergies. We will accommodate as much as possible."}
                  </p>
                </div>
